...
{
	m_ResultBG = CScene2DDX::Create(PRIORITY_2D, ".\\data\\TEXTURE\\result00.jpg",
	...
	CRanking::Create(D3DXVECTOR3(SCREEN_WIDTH * 0.65f, SCREEN_HEIGHT * 0.45f, 0.0f),
		D3DXVECTOR2(SCREEN_WIDTH * 0.5f, SCREEN_HEIGHT * 0.8f), 10.0f);
