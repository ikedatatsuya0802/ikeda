...
void CPlayer::UpdateMove(void)
{
	...
	// 回転反映
	m_MoveVec.x = CGame::GetRailLine()->GetSplinePos(m_Per + 0.01f).x;
	m_MoveVec.z = CGame::GetRailLine()->GetSplinePos(m_Per + 0.01f).z;
