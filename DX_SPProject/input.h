...
public:
	...
	static bool	GetMousePress(void){ return (m_aMouseState & 0x80) ? true : false; }
	static bool	GetMouseTrigger(void){ return (m_aMouseStateTrigger & 0x80) ? true : false; }
	static bool	GetMouseRelease(void){ return (m_aMouseStateRelease & 0x80) ? true : false; }
	static bool	GetMouseRepeat(void){ return (m_aMouseStateRepeat & 0x80) ? true : false; }

	static bool	GMP(void){ return (m_aMouseState & 0x80) ? true : false; }
...
private:
	...
	static BYTE		m_aMouseStateRelease;	// マウスの左ボタンリリース情報
	static BYTE		m_aMouseStateRepeat;	// マウスの左ボタンリピート情報

	static int		m_aMouseRepeatCount;	// キーボードのリピートカウント
...
public:
	...
	#define	KR_SPACE	(CInput::GetKeyboardRelease(DIK_SPACE))
};
...
public:
	...
	#define	KRP_SPACE	(CInput::GetKeyboardRepeat(DIK_SPACE))
};
